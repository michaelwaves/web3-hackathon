...
export default function PatentDisplaySmall({ title, number, filingDate, issueDate, abstract, inventors, image, onClick, buttonText }) {
    ...
    return (
        <div className="w-80 h-auto border-gray-800 rounded-xl py-4 border-[1px] shadow-md">
            <div className="flex flex-col space-y-2 items-center justify-center text-lg">
